...
import { common_printers_get, equipment_action, ROUTE_EQUIPMENT_PRINTER_KITCHEN_PRINT } from '../../../service/fetch_service.js'
            ...
            >
                {sortedKP.map((printer) => (
                    <Button
                        onClick={() => {
                            dispatch(
                                equipment_action(filial, ROUTE_EQUIPMENT_PRINTER_KITCHEN_PRINT, {
