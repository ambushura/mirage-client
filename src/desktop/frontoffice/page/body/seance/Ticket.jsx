        ...
        return (
            <Box className="checkout-order-ticket">
                ...
                <Box className="checkout-order-ticket-body">
                    <img
                        className="checkout-order-ticket-body-cover"
                        src={
                            pre_order.seance_cover_link === ''
                                ? cover
                                : `http://${filial.media_ip}:${filial.media_port}/${pre_order.seance_cover_link}`
                        }
                        alt={pre_order.film_name}
                    ></img>
