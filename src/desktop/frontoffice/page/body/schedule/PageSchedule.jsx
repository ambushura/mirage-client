...
import { cleanSchedule, setSchedule } from '../../../../../redux/desktop/frontoffice/scheduleReducer.js'
                        ...
                        if (filial_data.error !== null) {
                            ...
                            return (
                                <Box key={filial_data.filial.uid}>
                                    <Box className="schedule-full-filial-name glass" style={{ width: `${content_width}px` }}>
                                        <Button variant="contained" color="secondary" sx={{ marginBottom: '5px', minWidth: '210px' }}>
                            ...
                            return (
                                <Box key={filial_data.filial.uid}>
                                    ...
                                    >
                                        <Box sx={{ minWidth: '210px', position: 'sticky', left: '4px' }}>{filial_data.filial.name}</Box>
                                    </Box>
                                    <Box className="schedule-full-filial" ref={(el) => elementsRef.current.set(index, el)}>
                                        {filial_data.data
                                            .slice()
                                            .sort((a, b) => {
                                            ...
                                            .map((hall) => {
                                                ...
                                                return (
                                                    <Fade key={hall.uid_hall} in={sortedSeances.length > 0} timeout={TIMEOUT} unmountOnExit>
