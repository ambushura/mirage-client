            ...
            >
                    ...
                    <Button
                        ...
                        onClick={() => {
                            if (props.type === 'horeca') {
                                dispatch(
                                    equipment_action(filial, ROUTE_EQUIPMENT_KKT_BILL_PRINT, {
                                        uid: printer.kkt.uid,
                                ...
                                dispatch(
                                    equipment_action(filial, ROUTE_EQUIPMENT_KKT_TICKETS_PRINT, {
                                        uid: printer.kkt.uid,
                                        uid_order: props.order.uid,
                                        uid_positions: props.uid_selected,
                                    })
                                )
                            }
                        }}
                ...
                {sortedKP.map((printer) => (
                    <Button
                        onClick={() => {
                            dispatch(
                                equipment_action(filial, ROUTE_EQUIPMENT_PRINTER_BILL_PRINT, {
                                    uid: printer.kitchen_point.uid,
                                    uid_order: props.order.uid,
                                })
                            )
                        }}
