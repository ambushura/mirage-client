...
} from '../../../../redux/desktop/frontoffice/interfaceReducer.js'
...
const Payment = (props) => {
                                            ...
                                            {chapter1 !== 'success' ? (
                                                <Checkbox
                                                    ...
                                                    onChange={() => {
                                                        ...
                                                        if (allSelected) {
                                                            payment_group_new[chapter0][chapter1][chapter2].items = selectedItems.filter(
                                                                (uid) => !item.__uids.includes(uid)
                                                            )
                                                        } else {
                                                            payment_group_new[chapter0][chapter1][chapter2].items = [
                                                        ...
                                                        payment_group_new[chapter0][chapter1][chapter2].selected = totalUids.every((uid) =>
    ...
    return (
        <Box
            ...
            className={
                (props.type === 'cinema' && pre_order_paying) || (props.type === 'horeca' && horder_paying) ? 'payment-paying' : null
            }
        >
            <Box className="payment-total">
                <Box className="payment-total-div">
                    ...
                    <Box sx={{ backgroundColor: '#e4e2e2' }}>
                        ...
                        <Box className="payment-total-sum">{Math.round(pre_order.sum).toLocaleString('ru-RU')}</Box>
                    </Box>
                    <Box>
                        <Box className="payment-total-title">Общепит</Box>
                        <Box className="payment-total-sum">{Math.round(horder.sum).toLocaleString('ru-RU')}</Box>
                    </Box>
                    <Box sx={{ backgroundColor: '#e4e2e2' }}>
                    ...
                    >
                        {horder_paying ? (
                            ...
                            <>
                                ...
                                <Box className="payment-total-sum">{total !== cash ? Math.abs(change).toLocaleString('ru-RU') : <></>}</Box>
                            </>
                        )}
                    </Box>
                </Box>
                ...
                {!show_payment_types ? (
                    ...
                    payment_methods.data.list.map((pm) => {
                                                ...
                                                if (payment_group[chapter0][chapter1][chapter2].items.includes(item.uid)) {
                                                    if (item.name_payment_type === null) {
                                                        ...
                                                        if (
                                                            ...
                                                            ['Сервис', 'Отложенная оплата', 'Смешанная'].includes(item.name_payment_type)
                                                        ) {
                                                            ok = false
                                                        }
                                                    }
                                                ...
                                                if (payment_group[chapter0][chapter1][chapter2].items.includes(item.uid)) {
                                                    if (item.name_payment_type === null) {
                                                        ...
                                                        if (
                                                            ...
                                                            ['Сервис', 'Отложенная оплата', 'На расчетный счет', 'Смешанная'].includes(
                        ...
                        if (ok) {
                            return (
                                <Button
                                    startIcon={<CircleIcon sx={{ color: buttonColor(pm.inn), width: '30px', height: '30px' }} />}
                                    variant={'outlined'}
                                    color="secondary"
