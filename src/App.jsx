        ...
        return (
            <Box id="app">
                ...
                <Routes>
                    ...
                    <Route path="/film/:param_city/:param_filial/:param_date/:uid_film" element={<AppRoutes current_page="film" />} />

                    <Route path="/schedule/:param_city/:param_filial/:param_date" element={<AppRoutes current_page="schedule" />} />

                    <Route path="/seance/:param_city/:param_filial/:uid_seance" element={<AppRoutes current_page="seance" />} />
                    ...
                    <Route path="/kitchen/:param_city/:param_filial/:param_date_admin/" element={<AppRoutes current_page="kitchen" />} />

                    <Route path="/menu/:param_city/:param_filial/" element={<AppRoutes current_page="menu" />} />
                    ...
                    <Route path="/admin/zbook/:param_city/:param_filial/:uid/" element={<AppRoutes current_page="admin/zbook" />} />

                    <Route path="/admin/receipt/:param_city/:param_filial/:uid/" element={<AppRoutes current_page="admin/receipt" />} />
                    ...
                    <Route path="/admin/operation/:param_city/:param_filial/:uid" element={<AppRoutes current_page="admin/operation" />} />
                    ...
                    <Route path="/admin/slip/:param_city/:param_filial/:uid/" element={<AppRoutes current_page="admin/slip" />} />
