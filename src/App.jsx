...
function App() {
  ...
  const {modal_opened, modal_type, modal_props, need_update} = useSelector(
    ...
    return (
        <Box id="app">
          ...
          <Box id="center-page">
            <Routes>
              <Route
                  path="/center/shift/revenue"
                  element={<CenterShift current_page={['shift', 'revenue']}/>}
              />

              <Route
                  path="/center/shift/results"
                  element={<CenterShift current_page={['shift', 'results']}/>}
              />

              <Route
                  path="/center/shift/operations"
                  element={<CenterShift current_page={['shift', 'operations']}/>}
              />

              <Route
                  path="/center/horeca/goods"
                  element={<CenterHoreca current_page={['horeca', 'goods']}/>}
              />

              <Route
                  path="/center/horeca/goods/recipes/:ref"
                  element={<CenterHoreca current_page={['horeca', 'recipe']}/>}
              />

              <Route
                  path="/center/horeca/store_state"
              ...
              <Route
                  path="/center/horeca/shift_state"
                  element={<CenterHoreca current_page={['horeca', 'shift_state']}/>}
              />

              <Route
                  path="/center/horeca/orders"
                  element={<CenterHoreca current_page={['horeca', 'orders']}/>}
              />

              <Route
                  path="/center/horeca/orders/:uid_order"
                  element={<CenterHoreca current_page={['horeca', 'order']}/>}
              />

              <Route
                  path="/center/horeca/store_diff"
                  element={<CenterHoreca current_page={['horeca', 'store_diff']}/>}
              />

              <Route
                  path="/center/cinema/orders"
                  element={<CenterCinema current_page={['cinema', 'orders']}/>}
              />

              <Route
                  path="/center/results/cashbox"
    ...
    return (
        <Box id="app">
          ...
          <Routes>
            ...
            <Route
                path="/films/:param_city/:param_filial/:param_date"
                element={<AppRoutes current_page="films"/>}
            />

            <Route
                path="/film/:param_city/:param_filial/:param_date/:uid_film"
                element={<AppRoutes current_page="film"/>}
            />

            <Route
                path="/schedule/:param_city/:param_filial/:param_date"
                element={<AppRoutes current_page="schedule"/>}
            />

            <Route
                path="/seance/:param_city/:param_filial/:uid_seance"
                element={<AppRoutes current_page="seance"/>}
            />

            <Route
                path="/seance/:param_city/:param_filial"
                element={<Navigate replace to={defaultRedirectKK}/>}
            />

            <Route path="/seance/:param_city/:param_filial/" element={<NotFound/>}/>

            <Route
                path="/mkitchen/:param_city/:param_filial/"
                element={<AppRoutes current_page="mkitchen"/>}
            />

            <Route
                path="/kitchen/:param_city/:param_filial/:param_date_admin/"
                element={<AppRoutes current_page="kitchen"/>}
            />

            <Route
                path="/menu/:param_city/:param_filial/"
            ...
            <Route
                path="/admin/zbook/:param_city/:param_filial/:uid/"
                element={<AppRoutes current_page="admin/zbook"/>}
            />

            <Route
                path="/admin/receipt/:param_city/:param_filial/:uid/"
            ...
            <Route
                path="/admin/operation/:param_city/:param_filial/:uid"
            ...
            <Route
                path="/admin/slip/:param_city/:param_filial/:uid/"
