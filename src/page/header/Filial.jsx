...
const Filial = (props) => {
    ...
    return (<NavLink
        to={`/${current_page}/${city.code}/${props.filial.uid === undefined ? 'all' : props.filial.eais}/${PARAM_DATE_SHIFT.find(el => el === current_page) !== undefined ? param_date + '/' : ''}${film !== null ? film.uid + '/' : ''}${PARAM_DATA_ADMIN_SHIFT.find(el => el === current_page) !== undefined ? param_date_admin + '/' : ''}`}>
