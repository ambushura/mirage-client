...
const initialState = {
    ...
    // Пинпад
    pinpad_uid: null, trigger_submit_pinpad: false, trigger_delete_pinpad: false,
}
...
export const {
    setUidKKT, setTriggerSubmitKKT, setTriggerDeleteKKT, setUidPinpad, setTriggerSubmitPinpad, setTriggerDeletePinpad,
