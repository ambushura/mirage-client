...
export const RETURNING_STATE_SLIP_WITHOUT_RECEIPT =
    'Вернули деньги на карту, но не пробили кассовый чек'
...
export const PARAM_DATA_ADMIN_SHIFT = [
    'kitchen',
    'admin/orders/cinema',
    'admin/orders/horeca',
    'admin/egais',
    ...
    [
        ...
        {id: 'kitchen', name: 'Кухня', path: ''},
        {
            ...
            path: [
                ...
                {id: 'admin/reports', name: 'Отчеты', path: ''},
                {
                    id: 'admin/zbooks',
