...
const ScheduleFilters = () => {
    ...
    return <Box component='form'>
        ...
        <Box sx={{display: 'flex', flexDirection: 'column'}}>
            ...
            <Box>{tags("large", true, 2, "schedule-film-copy_type-tags", film_copy_types, "Типы копии фильма", "Тип копии фильма", film_copy_types_selected)}</Box>
            <Typography variant='subtitle2' color="textSecondary" sx={{mb: 1}}>
            ...
            <Box sx={{margin: '0 20px'}}>
                <Slider
                    ...
                    max={100}
                    step={25}
                    marks={[{value: 0, label: '0+'}, {value: 25, label: '6+'}, {
                        value: 50, label: '12+'
                    }, {value: 75, label: '16+'}, {value: 100, label: '18+'}]}
            ...
            <Box sx={{margin: '0 20px'}}>
                <Slider
                    ...
                    onChangeCommitted={(e, new_value) => {
                        ...
                        const snapped = new_value.map(el => snapToMark(el, [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100]))
                        dispatch(setScheduleFiltersTime(snapped))
                    }}
                    min={0}
                    max={100}
                    step={4}
                    marks={[{value: 0, label: '7'}, {value: 4, label: ''}, {value: 8, label: '9'}, {
                        value: 12, label: ''
                    }, {value: 16, label: '11'}, {value: 20, label: ''}, {value: 24, label: '13'}, {
                        value: 28, label: ''
                    }, {value: 32, label: '15'}, {value: 36, label: ''}, {value: 40, label: '17'}, {
                        value: 44, label: ''
                    }, {value: 48, label: '19'}, {value: 52, label: ''}, {value: 56, label: '21'}, {
                        value: 60, label: ''
                    }, {value: 64, label: '23'}, {value: 68, label: ''}, {value: 72, label: '1'}, {
                        value: 76, label: ''
                    }, {value: 80, label: '3'}, {value: 84, label: ''}, {value: 88, label: '5'}, {
                        value: 92, label: ''
                    }, {value: 96, label: '6'}, {value: 100, label: '7'},]}
                    valueLabelDisplay='off'
                    disableSwap
                />
            </Box>
