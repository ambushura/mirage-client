...
const HorecaFilters = () => {
    ...
    const filters_kitchen_points = useSelector(
        (state) => state.orders.orders_horeca_filters_kitchen_points
    )
    const filters_kitchen_state = useSelector(
        (state) => state.orders.orders_horeca_filters_kitchen_state
    )
    ...
    return (
        <Box className="admin-orders-horeca-filial-filters">
            ...
            {tags(
                ...
                true,
                4,
                'orders-kitchen-points-tags',
                filters_kitchen_points,
                'Кухня',
                'Цех',
                kitchen_points_selected
            )}
            {tags(
                'large',
                true,
                4,
                'orders-kitchen-state-tags',
                filters_kitchen_state,
                'Готовность',
                'Статус',
                kitchen_state_selected
            )}
            <Box
