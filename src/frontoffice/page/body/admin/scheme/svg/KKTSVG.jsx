export function KKTSVG() {
    return (
        <svg width="150" height="130" viewBox="0 0 200 180" xmlns="http://www.w3.org/2000/svg">
            <rect x="70" y="30" width="60" height="30" rx="4" ry="4" fill="#eee" stroke="#bbb" strokeWidth="1" />
            <line x1="75" y1="28" x2="125" y2="28" stroke="#aaa" strokeWidth="2" />
            <line x1="75" y1="33" x2="125" y2="33" stroke="#aaa" strokeWidth="1" />
            <rect x="20" y="60" width="160" height="100" rx="6" ry="6" fill="#444" stroke="#222" strokeWidth="2" />
            <rect x="30" y="140" width="140" height="25" rx="2" ry="2" fill="#555" stroke="#333" strokeWidth="1" />
