export function KitchenPointSVG() {
    return (
        <svg width="150" height="150" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <rect x="40" y="70" width="120" height="80" rx="8" ry="8" fill="#333" stroke="#111" strokeWidth="2" />
            <path
                ...
                strokeWidth="1"
            />
            <path d="M60,74 v20 a4,4 0 0 0 4,4 h72 a4,4 0 0 0 4,-4 v-20" fill="#eee" stroke="#ccc" strokeWidth="1" />
