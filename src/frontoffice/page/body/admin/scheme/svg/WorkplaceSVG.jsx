export function WorkplaceSVG() {
    return (
        <svg width="200" height="180" viewBox="0 0 200 180" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="40" y="40" width="120" height="70" rx="6" ry="6" fill="#333" stroke="#111" strokeWidth="2" />
            <rect x="50" y="50" width="100" height="50" fill="url(#screenGradient)" stroke="#006" strokeWidth="1" />
