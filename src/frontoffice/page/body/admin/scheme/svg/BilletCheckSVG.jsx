export function BilletCheckSVG() {
    return (
        <svg width="200" height="160" viewBox="0 0 200 160" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="70" y="30" width="60" height="100" rx="12" ry="12" fill="#222" stroke="#000" strokeWidth="2" />
            <rect x="76" y="38" width="48" height="84" rx="6" ry="6" fill="url(#screenGradient)" stroke="#003366" strokeWidth="1" />
