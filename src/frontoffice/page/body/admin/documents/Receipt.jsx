...
const Receipt = () => {
        ...
        if (uid === 'new') {
          ...
          if (data?.data) {
            reset({
              ...
              date_shift_confirm: data.data.date_shift_confirm
                ? dayjs(parceZone(data.data.date_shift_confirm))
                : null,
  ...
  const onSubmit = (data) => {
    ...
    if (prepared.date_create)
      prepared.date_create = dayjs(prepared.date_create).format('YYYY-MM-DDTHH:mm:ss+00:00')
    if (prepared.moment)
      prepared.moment = dayjs(prepared.moment).format('YYYY-MM-DDTHH:mm:ss+00:00')
