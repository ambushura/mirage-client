...
const Slip = () => {
    ...
    useEffect(() => {
        dispatch(
            setCaptionSlip(
                `БАНКОВСКИЙ СЛИП ${uid === 'new' ? ' * ' : ' RRN ' + slip14 + ' от ' + dayjs(date_shift).format('DD.MM.YY') + ' ID ' + slip27}`
            )
        )
        return () => {
    ...
    if (loading) {
        ...
        return (
            <Box id="modal-slip" component="form" noValidate autoComplete="off" sx={{ padding: '10px' }}>
                <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', m: 1, flex: 1 }}>
                        ...
                        <ControlledLazySelect
                            ...
                            readOnly={true}
                        />
                        <ControlledMoneyField control={control} name="slip_sum" label="0 · Сумма операции" readOnly={true} />
                        <ControlledTextField control={control} name="inn" label="ИНН" readOnly={true} />
                        <ControlledTextField
                            control={control}
                            name="slip86"
                            ...
                            readOnly={true}
                        />
                        <ControlledSwitch control={control} name="printed" label="Напечатан" color="secondary" readOnly={true} />
                    </Box>
                    <Box sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', m: 1, flex: 1 }}>
                        <Typography sx={{ textAlign: 'center' }} variant="h6" color="textSecondary">
                            Поля 4 - 11
                        ...
                        <ControlledTextField
                            ...
                            readOnly={true}
                        />
                        <ControlledTextField control={control} name="slip10" label="10 · Номер карты" readOnly={true} />
                        <ControlledTextField control={control} name="slip11" label="11 · Срок действия карты" readOnly={true} />
                        <ControlledLazySelect
                            control={control}
                            name="slip_type"
                            label="Тип слипа"
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', m: 1, flex: 1 }}>
                        ...
                        <ControlledTextField control={control} name="slip13" label="13 · Код авторизации" readOnly={true} />
                        <ControlledTextField control={control} name="slip14" label="14 · Номер ссылки" readOnly={true} />
                        <ControlledTextField control={control} name="slip15" label="15 · Код ответа" readOnly={true} />
                        <ControlledTextField control={control} name="slip19" label="19 · Дополнительные данные ответа" readOnly={true} />
                        <ControlledDatePicker
                            control={control}
                            name="slip21"
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', m: 1, flex: 1 }}>
                        ...
                        <ControlledTextField
                            ...
                            readOnly={true}
                        />
                        <ControlledTextField control={control} name="slip39" label="39 · Статус проведения транзакции" readOnly={true} />
                    </Box>
                </Box>
            </Box>
        )
