        ...
        <TabContext value={value}>
            <Box sx={{borderBottom: 1, borderColor: 'divider'}}>
                <TabList
                    ...
                    sx={{
                        '& .MuiTab-root': {
                            color: '#666', textTransform: 'none', fontSize: '16px',
                        }, '& .Mui-selected': {
                            color: '#000 !important', fontWeight: 'bold',
                        }, '& .MuiTabs-indicator': {
                            backgroundColor: '#000',
                        }
                    }}
            ...
            <TabPanel value='4' sx={{color: '#000'}}>
                <Button variant='_1c'
                        color='secondary'>Переместить</Button></TabPanel>
            <TabPanel value='5' sx={{color: '#000'}}>
                <Button variant='_1c' color='secondary'>Оприходовать</Button>
            </TabPanel>
        </TabContext>
    </Box>
}
