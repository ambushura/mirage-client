import { Box, InputAdornment, List, ListItem, ListItemButton, ListItemText, TextField } from '@mui/material'
...
import { setCities, setCity } from '../redux/frontmobile/frontMobileReducer.js'
        ...
        <Box className="front-mobile-auth">
            <AnimatePresence mode="wait">
                <PageWrapper key={city === null ? 'city' : 'filial'}>
                    {city === null ? pages['city'] : filial === null ? pages['filial'] : null}
                </PageWrapper>
            </AnimatePresence>
        </Box>
    )
        ...
        <Box className="front-mobile-auth-list">
            ...
            {cityName && (
                <Box className="front-mobile-auth-city-bar">
                    ...
                    <Box className="front-mobile-auth-city-back" onClick={onBack}>
                        ← Сменить город
                    </Box>
                </Box>
            )}
