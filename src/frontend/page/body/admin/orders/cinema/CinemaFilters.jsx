...
const CinemaFilters = () => {
    ...
    return (<Box className='admin-orders-cinema-filial-filters'>
        ...
        <PhoneInput value={buyer_phone_numbers_selected}
                    set_value={set_buyer_phone_number}
                    clear_value={clear_buyer_phone_number}/>
        <TextField sx={{width: '100%', marginBottom: '4px'}}
                   variant='filled'
                   label='E-mail'
                   type="email"
                   ...
                   InputProps={{
                       endAdornment: buyer_emails_selected && (<InputAdornment position="end">
                           <IconButton
                               onClick={() => dispatch(setOrdersCinemaFiltersBuyerEmailsSelect(''))}
                               edge="end">
                               <CloseIcon/>
                           </IconButton>
                       </InputAdornment>)
