...
export function FilialForm({props}) {
    ...
    return <Box>
        ...
        <FormGroup sx={{marginBottom: 1, display: 'flex', flexDirection: 'column', width: 'inherit', color: 'black'}}>
            ...
            <Box sx={{display: 'flex', flexDirection: 'column'}}>
                ...
                <Button variant='contained' color='secondary'>Закрыть на всех устройствах</Button>
            </Box>
        </FormGroup>
    </Box>
}