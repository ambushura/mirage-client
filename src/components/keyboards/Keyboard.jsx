...
const Keyboard = (props) => {
    ...
    const layouts = {
        en: {
            default: ["` 1 2 3 4 5 6 7 8 9 0 - = {bksp}", "q w e r t y u i o p", "a s d f g h j k l {enter}", "{shift} z x c v b n m", ".com @ {lang} {space} {lang}"],
            shift: ["~ ! @ # $ % ^ & * ( ) _ + {bksp}", "Q W E R T Y U I O P", "A S D F G H J K L {enter}", "{shift} Z X C V B N M", ".com @ {lang} {space} {lang}"]
        }, ru: {
            default: ["ё \" 1 2 3 4 5 6 7 8 9 0 - = {bksp}", "й ц у к е н г ш щ з", "ф ы в а п р о л д ж э {enter}", "{shift} я ч с м и т ь б ю", ".com @ {lang} {space} {lang}"],
            ...
            default: ["7 8 9", "4 5 6", "1 2 3", "0 {enter}"], shift: ["7 8 9", "4 5 6", "1 2 3", "0 {enter}"]
        }
    }
    return (<Box>
        <SimpleKeyboard
            onChange={props.setInput}
            buttonTheme={[{class: "mirageEnterKey", buttons: "all"}, {
