        ...
        <li className={`order-box-horeca-item ${props.uid_selected.includes(props.item.uid) ? 'position-selected' : ''}`}>
            <Box
                ...
                <button className='order-box-horeca-item-1-2'
                        onClick={() => dispatch(openModal({type: 'comment', props: {order_type: 'horeca', action_type: 'position', uid_order: props.uid_order, uid_position: props.item.uid}}))}><BorderColorIcon
